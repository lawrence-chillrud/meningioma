...
output_dir = 'data/preprocessing/output/4_INTENSITY_STANDARDIZED'
...
os.system(f"echo '\nRunning script 4a_intensity_standardization.py at {date}\n' >> {log_file}")
...
os.system(f"echo 'Completed 4a_intensity_standardization.py at {date}' >> {log_file}")
