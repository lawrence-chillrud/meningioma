...
def detailed_n4_inspection(data_dir='data/preprocessing/output', subject='6', session='6_Brainlab', scan='12-AX_3D_T1_POST', cmap='nipy_spectral', orientation='IAL', bias_field=False):
